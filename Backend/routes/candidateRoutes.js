...
// vote count endpoint - MUST come BEFORE /vote/:candidateID
router.get('/vote/count', async (req, res) => {
    try{
        // Aggregate vote counts by party (sum of voteCount for each party)
        const voteRecord = await Candidate.aggregate([
            { $group: { _id: '$party', count: { $sum: '$voteCount' } } },
